...
watch(() => route.fullPath, () => { void refreshRecommendations().catch(() => undefined) })
</script>
...
<template>
  ...
  <div v-else class="zt-app-shell min-h-screen">
    ...
    <main class="mx-auto w-full max-w-[1600px] px-4 py-4 sm:px-5 lg:px-6 lg:py-5"><RouterView :key="route.path" /></main>
  </div>
</template>
