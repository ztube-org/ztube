...
test('next Viewing Window is expressed in the Child timezone before and after today’s window', () => {
  assert.deepEqual(playbackPolicyAt(new Date('2026-08-17T13:59:00Z'), settings, {}).nextWindow,
    { day: 'today', time: '07:00', timeZone: 'America/Los_Angeles' })
  assert.deepEqual(playbackPolicyAt(new Date('2026-08-18T03:00:00Z'), settings, {}).nextWindow,
    { day: 'tomorrow', time: '07:00', timeZone: 'America/Los_Angeles' })
  assert.equal(playbackPolicyAt(new Date('2026-08-17T14:00:00Z'), settings, {}).nextWindow, null)
})
